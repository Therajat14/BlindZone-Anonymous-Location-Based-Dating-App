    ...
    <div className="flex min-h-screen flex-col justify-between p-6">
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
        <div className="mb-12 text-center">
          <div className="bg-primary-500/10 mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full">
            <Heart className="text-primary-500 h-10 w-10" fill="currentColor" />
          </div>
        ...
        <div className="mb-12 space-y-6">
          <div className="flex items-center space-x-4">
            <Shield className="text-secondary-500 h-6 w-6 flex-shrink-0" />
            <p className="text-gray-300">100% Anonymous Until You Choose</p>
          </div>
          <div className="flex items-center space-x-4">
            <MapPin className="text-warning-500 h-6 w-6 flex-shrink-0" />
            <p className="text-gray-300">Discover People Around You</p>
          </div>
          <div className="flex items-center space-x-4">
            <MessageCircle className="text-success-500 h-6 w-6 flex-shrink-0" />
